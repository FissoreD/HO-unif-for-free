...
\begin{frame}[fragile]
  ...
  \begin{array}{l}
    ...
    \runH{\foUnifPb}{n}{\rho} \deff \vspace{2pt}\\
      \qquad \hoUnifPb \times \mapStore \times \linkStore_0 = \{ (t,m,l) | s \in \foUnifPb, \C{s}{t}{m}{l} \}\vspace{2pt} \texttt{:= compilation}\\
      \qquad \runHD{\hoUnifPb}{n}{\linkStore}\vspace{2pt} \texttt{\phantom{aaaaa}:= runtime}\\
      \qquad \D{\sigma_{n}}{\mapStore}{\linkStore_{n}}{\rho_{n}} \texttt{\phantom{aaaaaaaaaaaaaaaaaaaaaa} := decompilation}
    \end{array}
  $$    
...
\begin{frame}
  ...
  \begin{itemize}
    ...
    \item TC search up to $\beta\eta$ can be implemented via Elpi rules
