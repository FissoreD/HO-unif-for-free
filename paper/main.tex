...
\begin{invariant}[\linkbeta \rhs]
  ...
  \todo[inline]{si dice: flexible term; oppure unification variable}
\end{invariant}
...
\begin{corollary}
  ...
  the current unification problem is not in \llambda
...
\begin{definition}[\progBetaLL]
  ...
  it exists a substitution $\gamma$, such that the first term $t$ is a name not
