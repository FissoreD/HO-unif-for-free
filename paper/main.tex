...
property, but wound certainly fail to verify \fullref{prop:fidelity}.
...
\end{lemma}
\begin{proof}[Proof sketch]
In this setting, \Ee is as strong as \Eo on ground terms and reflexivity for
unification variables. What we have to show is that whenever two different \Fo{}
