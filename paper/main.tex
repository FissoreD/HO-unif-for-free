...
property is given by the following code:
...
\begin{invariant}[\linketa left hand side]
  The left hand side of a \linketa is a variable.
  \label{invariant:link-eta-left}
\end{invariant}

\begin{invariant}[\linketa right hand side]
  The right hand side of a \linketa having the shape $\lambda x.F \appsep x$
...
We want maintain invariants~\ref{invariant:link-eta-left} and \ref{invariant:link-eta-right}
