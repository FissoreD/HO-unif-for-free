...
are first class terms, i.e. they have a concrete syntax.
...
We defer the description of \elpiIn{beta} to \cref{sec:grounwork}, for now
...
\begin{definition}[\notllambda]\label{def:notllambda}
  $\notllambda = \{ X \appsep t_1 \ldots t_n ~|~ X \appsep t_1 \ldots t_n ~\mathrm{are~not~distinct~names} \}$.
\end{definition}
...
\todo{dire che W preservation is key for our claims}
