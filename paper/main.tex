...
\newcommand{\stepFD}[4]{\ensuremath{#3 #1_{#2_l} \Uo #3 #1_{#2_r} \mapsto #4}}
\newcommand{\stepHD}[6]{\ensuremath{%
#3 #1_{#2_l} \Ue #3 #1_{#2_r} \mapsto #4 \land \solve(#6,#4) \mapsto #5}}
\newcommand{\runF}[3]{\ensuremath{\frun(#1,#2) \mapsto #3_{#2}}}
\newcommand{\runH}[3]{\ensuremath{\hrun(#1,#2) \mapsto #3_{#2}}}
\newcommand{\runFD}[2]{\ensuremath{\bigwedge_{p = 1}^{#2} \stepF{#1}{p}{\rho_{p-1}}{\rho_{p}}}}
\newcommand{\runHD}[3]{\ensuremath{\bigwedge_{p = 1}^{#2} \stepH{#1}{p}{\sigma_{p-1}}{\sigma'}{\sigma_{p}}{#3}}}
\newcommand{\deff}{\ensuremath{\stackrel{{\scriptscriptstyle def}}{=\!=\!\!\!=}}}
$$
\begin{array}{l}
\stepF{\mathcal{S}}{p}{\rho}{\rho'}
\deff
\stepFD{\mathcal{S}}{p}{\rho}{\rho'}\\
...
$$
\begin{array}{l}
\stepH{\mathcal{T}}{p}{\sigma}{\mathbb{L}}{\sigma''} \deff\\
  \qquad\stepHD{\mathcal{T}}{p}{\sigma}{\sigma'}{\sigma''}{\mathbb{L}}\\
\runH{\mathcal{S}}{\mathcal{N}}{\rho} \deff \\
  \qquad \mathcal{T} \times \mathbb{M} \times \mathbb{L} = \{ (t_j,m_j,l_j) | s_j \in \mathcal{S}, \C{s_j}{t_j}{m_j}{l_j} \}\\
  \qquad \runFD{\mathcal{S}}{\mathcal{N}}{\mathbb{L}}\\
  \qquad \D{\sigma_{\mathcal{N}}}{\mathbb{M}}{\rho_{\mathcal{N}}}
\end{array}
$$
