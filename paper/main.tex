...
\begin{theorem}[Fidelity in \maybeeta]
  ...
  map memory is bijective,
  the introduction 
  of \linketa guarantees \fullref{prop:fidelity}.
  \footnote{A map memory is bijective if any higher-order variable is applied
  with the same number of arguments. This problem is addressed in
  \cref{sec:invariant1}}
