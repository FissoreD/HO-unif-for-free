...
\newcommand{\printLinks}[3]{
  \noindent
  \begin{description}[leftmargin=!,labelwidth=\widthof{\bfseries Unif problems:}]
    \item[Unif problems:] \printMinipage{#1}
    \item[Mappings:] \printMinipage{#2}
    \item[Links:] \printMinipage{#3}
  \end{description}
}
