...
\begin{theorem}[Fidelity in $\wellb_{\beta \eta}$]
  ...
  $\wellb_{\beta \eta}(\foUnifPb)$ and if the 
...
\begin{proof}[Proof sketch]
  ...
  \todo{Fix: show that 5.7 an 5.8 compensate for missing eta rule, citare regolae in =o}
...
\begin{proof}[Proof sketch]
  ...
  variables with different arities are compiled to two
  variables $A^n$ and $C^m$ related by a chain of \linketa.
  We show that whenever one of the two is instantiated with a rigid term then
