...
\begin{invariant}
  ...
  Any variable in the substitution with arity \elpiIn{N} is always fully applied
  TODO: move this to the right place
  TODO: definire normal form, maybe in definition 2.7
  \label{inv:fully-applied-vars}
\end{invariant}
...
\begin{definition}[reduce-to]
  ...
  (since $\lambda x_1 \ldots x_n.x_{x_1\ldots x_n} = x$) ; 3) $t$ is a unification
...
$l_2$ be \elpiIn{uva V S}, then, by \cref{inv:fully-applied-vars}, \elpiIn{R}
...
unification which are terminating instructions. If a link is deduplicated, the
