...
the context $\Gamma$).
\noteE[inline]{there was a note about T' having a rigid head, TO BE FIXED}
\end{definition}
...
We delay in next section a \linketa progression due to \progressetaright
...
\noteD[inline]{ci vuole l'esempio per il \progressetaright}
...
\begin{corollary}
  ...
  \noteE[inline]{it is clear. Quello che manca è percè serve farlo, e che cosa si guadagna. Qui dimostri che fallire "ha senso" se siamo solo interessati a llambda, ma allo stesso tempo sti beta link sono lì per gestire roba fuori.}
\end{corollary}
