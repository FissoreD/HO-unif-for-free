...
\begin{proof}[Proof sketch]
  We want to prove that for any $i$, $\fstep_i$ succeeds iff $\hstep_i$
  succeeds. An $\hstep_i$ is made by a unification
  ...
  The interesting case is when the infolved terms are in \maybeeta.
