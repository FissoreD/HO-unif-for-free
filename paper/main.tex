...
examples, they cannot be symbols of the meta language.
...
system where explicit
control is given the user.
...
overhead on small goal but is consistently faster than
