...
\begin{definition}[\progBetaLL]
  ...
  occurring in $S$. In this case, let $M$ a fresh variable, then the new links
  \linkbetaM{\Gamma,x}{X}{M_{S,n}\appsep L} and \linketaM{\Gamma}{N}{\lambda
  x.M_x} are added to \linkStore.
\end{definition}
...
\begin{corollary}
  Given \linkbetaM{\Gamma}{X}{\rhsBeta}, then \elpiIn{distinct-name} $S$ holds.  
\end{corollary}
