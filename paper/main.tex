...
The predicate xxxx \todo{add} takes
a link \linketaM{\Gamma}{X_{x_1\ldots x_n}}{t} and replaces it by
\linketaM{{x_1\ldots x_n}}{X_{x_1\ldots x_n}}{t'} whenever $\{x_1\ldots x_n\} \subset \Gamma$.
The term $t' = \lambda x.Y_{{x_1\ldots x_n},x}$ after
executing $\lambda x.Y_{{x_1\ldots x_n}~x} \Ue t$, that is $t'$ cannot contain
variables in $\Gamma / \{x_1\ldots x_n\}$.
This is key for fidelity since suspended unif problem
must stay solvable.
...
\begin{proof}[Proof sketch]\todo{to reformulate}
  ...
  progression $p$.
  Without loss of generality,\todo{explain why} we consider a
  ...
  \begin{itemize}
    \item $s_2 \notin \maybeeta$,
          ...
          $\lambda x.t_2\appsep x$, otherwise they unify thanks to lam-lam\todo{dare nome}
