...
\paragraph{Decompilation}
During \elpiIn{progress}, as claimed in \fullref{inv:beta-rhs}, the decompilation
can only have \linkbeta with not instantiated \lhs. In this case, \lhs is
unified with \rhs.
\todo{qui falliamo, nella 7.3 dire che LHS è in llambda quindi LSH = Ugly può funzionare,
in Elpi funziona però in questi casi il termine in llam deve essere a sinistra}.
...
\newcommand{\progBetaLH}{\emph{progress-\llambda-\lhs}\xspace}
...
\subsection{Relaxing \fullref{def:progBetaLH}}
