...
We write this step $\C{s}{t}{m}{l}$. The implementation of the compiler
...
In the context of \hrun, if $\sigma_{p-1} \hoUnifPb_{p} \in \llambda$ then
$$
...
\begin{proposition}[\wellb-enforcing]\ref{prop:w-enforcing}
