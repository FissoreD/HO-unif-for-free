...
\begin{proof}[Proof sketch]
  ...
  \maybebeta, then, by \cref{cor:keep-fidelity}, the unification fails, as per
...
\begin{proof}[Proof sketch]
  By contradiction,\noteE{we assume to have a link} if $m = 0$, then the original \Fo{} term
  ...
  \linkbeta is produced: a contradiction.\noteE{since we started by assuming we had a link}
\end{proof}
