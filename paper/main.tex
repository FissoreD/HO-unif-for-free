...
\begin{definition}[\progBetaLL]
  ...
  list of arguments and $Y$ being a fresh variable. Moreover, the new \linkbeta,
...
\begin{proof}[Proof sketch]
  ...
  \progBetaRH, then it desappears from \linkStore and \elpiIn{progress}
...
and $E$ is assigned to $\lambda x.x$.
...
problem assignes $f$ to $B$, that in turn activates
...
\noteD{nope. Si risolve tutto by \progBetaLL}
