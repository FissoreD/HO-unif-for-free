...
\noindent
TODO: about the cut\marginpar{should we rename forall2 into map}
...
properties \ref{prop:correct-ml,prop:complete-ml}. Although we provide an
implementation in the appendix (that we used for testing purposes) we only
describe its signature. Elpi is expected to provide this brick, as well as
