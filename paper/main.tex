...
which is in \maybeeta{} since $x$ does not \occursrigid{} in the first argument
of $f$,
and the second argument of $f$ \reduceto{} $x$. In other words $A \appsep x$
may either use $x$ or discard it.\\
...
variable is instantiated, and that compensates for the
