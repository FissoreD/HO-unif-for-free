...
$Y \Ue t$\noteD{shouldn't be uva Y [] \Ue t} that succeeds with $\sigma = \{ Y \mapsto t\}$ and
...
\noteD{first rule is wrong, since maybe-eta is 1-argument pred}
