...
\elpiIn{Ag} cannot create new mappings nor links, since \elpiIn{Ag}
...
Note that \elpiIn{pi x y\..} is syntactic sugar for \elpiIn{pi x\ pi y\..}.
...
note \elpiIn{(a = b) c d} is \elpiIn{(=) a b c d}.
