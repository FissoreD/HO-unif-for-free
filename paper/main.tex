...
Constructions~\cite{felty93lics}.
The object logic we are interested in is Coq's~\cite{Coq-refman}
Calculus of inductive Constructions (Cic), and we want to code a
type-class~\cite{wadler89} solver for Coq~\cite{Coq-refman} using
the Coq-Elpi~\cite{tassi:hal-01637063}
...
As an example we take the \coqIn{Decide} type class
...
the following statement automatically by back-chaining the lemmas above:
