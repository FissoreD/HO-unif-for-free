...
Detection of \maybebeta is quite simple to implement in the compiler, it is 
sufficient to 

Dire che maybebeta is simple to detect e che maybe eta funziona bene and su 
termini che non sono il llambda

\begin{corollary}
  Right hand side is $X_{scope} t_1 \dots t_n$ and $t_1$ is in $scope$ or
  $t_1$ is not a name
\end{corollary}
