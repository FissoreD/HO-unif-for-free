...
are used to represent the object logic ones; 2)
...
that were used to implement various formal systems such as
...
want to implement a unification procedure \U{} using the ML
