...
The \coq instance on the left is compiled in the \elpi rule on the right. If 
we try to solve the following query (already in the \elpi syntax)

\elpiIn{tc-Decision (prod x\ app[f, y, x])}
...
An other example of unification failure in the 
...
\begin{itemize}
  \item TODO: context
  \item TODO: example
  \item TODO: riassunto delle next sections
\end{itemize}
