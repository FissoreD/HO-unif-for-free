...
\begin{mintedTcolorbox}{coq}
  Class XXX Args := {methods ...}.
  Instance ZZZ : bla bla -> XXX Args := {...} Qed.
  Instance WWW : bla bla -> XXX Args := {...} Qed.
\end{mintedTcolorbox}

This small set of instance thanks a first phase of class and instance\todo{explain compilation of pred and inst?}
compilation is translated into the following \elpi program:

\begin{mintedTcolorbox}{elpi}
  type XXX Args .. -> term -> o.
  XXX Args ... (ZZZ P1 ... PN) :-
    premese...
  WWW Args ... (ZZZ P1 ... PN) :-
    premese...
...
in the meta language is not sufficiently powerful to understand that two terms
unifying in the object language should also unify in the meta language.
