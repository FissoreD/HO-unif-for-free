...
% Let upper-case letter unification variables and lower case variables defined
% constants of the object language. We take as example the following two
% unification problems in our \ol:

% \begin{center}
%   \coqIn{(fun x => P x) = P}
% \end{center}

% The first problem, if 
